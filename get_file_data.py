...
def get_file_data(sheet_name, access_token, site_id, item_id):
    ...
    # For SharePoint use: 
    download_url = f"https://graph.microsoft.com/v1.0/sites/{site_id}/drive/items/{item_id}//workbook/worksheets/{sheet_name}/usedRange"
